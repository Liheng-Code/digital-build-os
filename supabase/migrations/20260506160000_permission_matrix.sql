...
DECLARE
  ...
  m TEXT;
  a TEXT;
  modules TEXT[] := ARRAY['projects', 'wbs', 'tasks', 'daily_reports', 'timesheets', 'approvals', 'rfis', 'architecture', 'analytics', 'financials', 'stakeholders', 'procurement', 'hse', 'subcontractors', 'structural'];
