...
CREATE TABLE public.pr_items (
  ...
  description TEXT, -- override or specific detail
...
CREATE POLICY "Authorized users can manage PRs" ON public.purchase_requisitions FOR ALL TO authenticated 
  USING (public.check_permission(auth.uid(), 'procurement', 'view'));
